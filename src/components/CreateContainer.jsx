        ...
        <>
            {user && user.email === 'phanquangduong2002@gmail.com' ? (
                <div className="w-full min-h-screen h-auto flex items-center justify-center">
                    <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex items-center flex-col justify-center gap-4">
                        {fields && (
                            <motion.p
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                    ...
                                    {!imageAsset ? (
                                        ...
                                        <>
                                            <div className="relative h-full ">
                                                ...
                                                <button
                                                    type="button"
                                                    className="absolute bottom-3 right-3 p-3 rounded-full bg-orange-400 text-xl cursor-pointer outline-none hover:shadow-md duration-500 transtion-all ease-in-out"
                                                    onClick={deleteImage}
                                                >
                                                    {' '}
